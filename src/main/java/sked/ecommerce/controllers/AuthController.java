...
import sked.ecommerce.payload.response.MessageResponse;
import sked.ecommerce.repository.RoleRepository;
import sked.ecommerce.repository.UserRepository;
import sked.ecommerce.security.JwtUtils;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        JwtResponse jwtResponse = new JwtResponse(jwt, userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(), userDetails.getAuthorities());
